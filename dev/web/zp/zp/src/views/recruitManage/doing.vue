 ...
 * @Last Modified time: 2019-12-27 22:06:10
 */
<template>
  <div id="recruitDoing" class="wrap">
    ...
    <el-dialog title="修改招聘" :visible.sync="editVisible" class="editDialog">
      <!-- {{currentEemployment}} -->
...
<script>
import { findAllEmployment,deleteEmploymentById,findEmploymentByJob,findEmploymentByWelfare,findEmploymentByTitle,findEmploymentByCity } from "@/api/employment.js";
...
export default {
  ...
  methods: {
      ...
      // 打开福利的dialog进行选择
      welfareBtn(){
        console.log(this.welfareValueInput);
      ...
      toEdit(row){
        ...
        // 获取福利数组
        this.splitWelfare(this.currentEemployment);
        this.welfareValueInput = this.welfare;
      },
      toDelete(id){
      ...
      // 分割福利
      splitWelfare(res){
        this.welfare = res.welfare.split('、');
      },
      // 获取公司名称
